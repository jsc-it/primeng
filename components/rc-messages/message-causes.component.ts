...
@Component({
	...
	template: `
		...
		<div *ngIf="selectedMessage" class="rc-message-cause-body">
			...
			<p-panel *ngFor="let msgCause of selectedMessage.message.messageCauses;let i = index;" class="rc-message-cause" header="{{ msgCause.cause }}" [toggleable]="true" [collapsed]="i==0?false:true">
				<div *ngIf="msg.remediation" class="rc-message-cause-remediation">{{ msgCause.remediation }}</div>
